...
def prepare(pfolder,nfolder,h,w,num_train):
    global folders
    ...
    move_some(folders[1],folders[0],num_train)
...
def create(name,pfolder,nfolder,ratio,num_samples,num_train):
    name = name+"_cascade.xml"
    ...
    prepare(pfolder,nfolder,h,w,num_train)
